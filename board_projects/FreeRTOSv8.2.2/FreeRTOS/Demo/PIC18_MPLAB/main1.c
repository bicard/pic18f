...
static void v7SegmentInit(void *pvParameters);
static void v7SegmentWrite(void *pvParameters);
...
void main( void )
{
	...
	xTaskCreate( v7SegmentWrite, "7Seg", configMINIMAL_STACK_SIZE, NULL, mainCHECK_TASK_PRIORITY, NULL );
